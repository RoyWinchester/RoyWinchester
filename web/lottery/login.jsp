...
<head>
    ...
    <script>
        ...
        function fnLogin() {
            ...
            if (document.fm.txtCode.value.isEmpty()){
                alert("验证码不能为空！");
                document.fm.txtCode.focus()
                return false;
            }
            return true;
        }
...
<div class="header" id="demo">
    ...
    <div class="row" id="container" align="center">
        <div class="nav">
            ...
            <form action="../servlet/LoginServlet" method="post" name="fm">
                <div class="logo_box">
                    <div id="content">
                        ...
                        <div class="input_outer" >
                            ...
                            <input placeholder="请输入6-20位字符密码" class="text" style="color: #FFFFFF !important; position:absolute; z-index:100;"
                                   value="" id="password" name="password" type="password" required=""></p>
                        </div> <br>
                        <div class="Verification">
                            <div class="input">

                                <input placeholder="请输入验证码" class="text1" style="color: #FFFFFF !important; position:absolute; z-index:100;" type="text" name="txtCode" id="txtCode" >

                            </div>
                            <div class="code">
                                <img src="../servlet/CreateYZMServlet" onclick="RenewCode(this)" title="点击图片刷新验证码" alt="点击图片刷新验证码" />
                            </div></div>
                        ...
                        <input onclick="return(fnLogin())" type="submit" class="btns" onmouseover="this.style.backgroundPosition='left -40px'"
                               onmouseout="this.style.backgroundPosition='center'"  value="登录">
                    </div>
            </form>
            <div class="home1">

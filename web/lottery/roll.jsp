...
<div style="width:1200px;height:1200px;margin:50px auto;zoom: 0.5;position: relative;" class="text-center div">
  ...
  <div id="modal1" class="modal">
	...
	<a href="../index.jsp" class=" modal-action modal-close waves-effect btn-gbf">返回首页</a>
        ...
        for (var i = 0; i < len; i++) {
            ...
            if(texture_list.length>1){
                if(i!=len-1){
                    ...
                    var pattern = sector.createPattern(texture_list[(i+2)%tex_num],"repeat");
                }

...
<div style="width:1200px;height:1200px;margin:50px auto;zoom: 0.5;position: relative;" class="text-center div">
  ...
  <div id="modal1" class="modal">
	...
	<a href="gbfdraw.html" class=" modal-action modal-close waves-effect btn-gbf">前往抽卡</a>
...
<script>
    ...
    function paintName(adata) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            sector.font = "60px Impact";
            sector.fillStyle = "white";
            sector.fillText(item.name, -300, -70);
            sector.restore();
    ...
    function price(arc){
        ...
        for(var i=0;i<data.length;i++){
            ...
            if(arc>=sec && arc<=end){
                $('#roll-result').text(data[i].name+"连无料！");
                $('#modal1').modal('open');
                break;
            }
